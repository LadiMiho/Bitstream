...
/// <c>wwwroot/js/pages/login.js</c> calling <see cref="Controllers.AuthController"/>'s
/// <c>SignInManager</c>-backed actions (<c>POST /Auth/Login</c>, <c>POST /Auth/Login/Verify</c>)
/// — this page only renders the form and decides where <c>/Login</c> sends an already-signed-in
/// visitor.
